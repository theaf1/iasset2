                                ...
                                <label for="section">หน่วยงาน</label>
                                    <select class="form-control @error('section') is-invalid @enderror" name="section" id="section">
                                        ...
                                        @foreach($sections as $section)
                                            <option value="{{ $section['id'] }}" {{ old('section',$server->section) == $section['id'] ? 'selected' : ''}}>{{ $section['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('section')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        @foreach ($owners as $owner)
                                            <input class="form-check-input @error('owner') is-invalid @enderror" type="radio" name="owner" id="owner" value="{{ $owner['id'] }}" {{ old('owner',$server->owner) == $owner['id'] ? 'checked' : ''}}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('asset_status') is-invalid @enderror" name="asset_status" id="asset_status">
                                    ...
                                    @foreach($asset_statuses as $asset_status)
                                        <option value="{{ $asset_status['id'] }}" {{ old('asset_status',$server->asset_status) == $asset_status['id'] ? 'selected' : '' }}>{{ $asset_status['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('asset_status')
                                    <div class="invalid-feedback">
                            ...
                            <label for="asset_use_status">สถานะการใช้งานของครุภัณฑ์</label>
                                <select class="form-control @error('asset_use_status') is-invalid @enderror" name="asset_use_status" id="asset_status">
                                    ...
                                    @foreach($asset_use_statuses as $asset_use_status)
                                        <option value="{{ $asset_use_status['id'] }}" {{ old('asset_use_status',$server->asset_use_status) == $asset_use_status['id'] ? 'selected' : '' }}>{{ $asset_use_status['name'] }}</option>
                                    @endforeach
                                </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        @foreach ($forms as $form)
                                            <input class="form-check-input" type="radio" name="form_factor" id="form_factor" value="{{ $form['id'] }}" {{old('form_factor',$server->form_factor) == $form['id'] ? 'checked' : '' }}>
                                    ...
                                    <label for=hdd_total_cap>ความจุรวมของ HDD</label>
                                        <div class="form-check-inline pl-1">
                                            @foreach ($dataunits as $dataunit)
                                                <input type="radio" class="form-check-input @error('data_unit') is-invalid @enderror" name="data_unit" id="data_unit" value="{{ $dataunit['id'] }}" {{ old('data_unit',$server->data_unit) == $dataunit['id'] ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('os') is-invalid @enderror" name="os" id="os">
                                        ...
                                        @foreach($server_oses as $server_os)
                                            <option value="{{ $server_os['id'] }}" {{ old('os',$server->os) == $server_os['id'] ? 'selected' : '' }}>{{ $server_os['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('os')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="role_class" id="role_class">
                                        ...
                                        @foreach($server_role_classes as $server_role_class)
                                            <option value="{{ $server_role_class['id'] }}" {{ old('role_class',$server->role_class) == $server_role_class['id'] ? 'selected' : '' }}>{{ $server_role_class['name'] }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('lan_type') is-invalid @enderror" name="lan_type" id="lan_type">
                                        ...
                                        @foreach($network_connections as $network_connection)
                                            <option value="{{ $network_connection['id'] }}" {{ old('lan_type',$server->lan_type) == $network_connection['id'] ? 'selected' : '' }}>{{ $network_connection['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('lan_type')
                                        <div class="invalid-feedback">
