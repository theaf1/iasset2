                            ...
                            <div class="col-sm-12 col-lg-6"> <!--การติตตั้ง-->
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input @error('is_mobile') is-invalid @enderror" type="radio" name="is_mobile" id="is_mobile" value="{{ $mobile['value'] }}" {{ old('is_mobile',$networkedstorage->is_mobile) == $mobile['value'] && old('is_mobile') !== null ? 'checked' : '' }}>
                                    ...
                                    <label for="hdd_total_cap">ความจุข้อมูลรวม</label>
                                        <div class="form-check-inline">
                                            @foreach ($dataunits as $dataunit)
                                                <input type="radio" name="data_unit" id="data_unit" value="{{ $dataunit['id']}}" class="form-check-input @error('data_unit') is-invalid @enderror pl-2" {{ old('data_unit',$networkedstorage->data_unit) == $dataunit['id'] ? 'checked' : '' }}>
