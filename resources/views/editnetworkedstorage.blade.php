...
@section('content')
    <div class="container-fluid">
        <div class="col-12 mx-auto">
            <form action="{{ url('/networkedstorage',$networkedstorage->id) }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--รหัส SAP-->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('sapid') is-invalid @enderror" id="sapid" name="sapid" value="{{ old('sapid',$networkedstorage->sapid) }}">
                                    @error('sapid')
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--รหัสครุภัณฑ์-->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="pid" name="pid" value="{{ old('pid',$networkedstorage->pid) }}">
                                </div>
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--ห้อง-->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('location_id') is-invalid @enderror" name="room" id="room_autocomplete" placeholder="กรุณาระบุห้องที่เครื่องตั้งอยู่" value="{{ old('room',$networkedstorage->NetworkedStorageRoom->name) }}"/>
                                    @error('location_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--การติตตั้ง-->
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input @error('mobility_id') is-invalid @enderror" type="radio" name="mobility_id" id="is_mobile" value="{{ $mobile['id'] }}" {{ old('mobility_id',$networkedstorage->mobility_id) == $mobile['id'] ? 'checked' : '' }}>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--เบอร์โทร-->
                                <div class="form-group">
                                    ...
                                    <input type="tel" class="form-control @error('tel_no') is-invalid @enderror" name="tel_no" id="tel_no" placeholder="9-9999" value="{{ old('tel_no',$networkedstorage->tel_no) }}">
                                    @error('tel_no')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--ผู้รับผิดชอบ-->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('response_person') is-invalid @enderror" id="response_person" name="response_person" value="{{ old('response_person',$networkedstorage->response_person) }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        @foreach ($storagetypes as $storagetype)
                                            <input class="form-check-input @error('storage_type_id') is-invalid @enderror" type="radio" name="storage_type_id" id="type" value="{{ $storagetype['id'] }}" {{ old('storage_type_id',$networkedstorage->storage_type_id) == $storagetype['id'] ? 'checked' : '' }}>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--ยี่ห้อ-->
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('brand') is-invalid @enderror" name="brand" id="brand" type="text" value="{{ old('brand',$networkedstorage->brand) }}">
                                    @error('brand')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--รุ่น-->
                                <div class="form-group">
                                    ...
                                    <input class="form-control  @error('model') is-invalid @enderror" name="model" id="model" type="text" value="{{ old('model',$networkedstorage->model) }}">
                                    @error('model')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--serial no.-->
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('serial_no') is-invalid @enderror" name="serial_no" id="serial_no" type="text" value="{{ old('serial_no',$networkedstorage->serial_no) }}">
                                    @error('serial_no')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--ความจุรวม-->
                                <div class="form-group">
                                    <label for="hdd_total_cap">ความจุข้อมูลรวม</label>
                                        <div class="form-check-inline">
                                            @foreach ($dataunits as $dataunit)
                                                <input type="radio" name="data_unit_id" id="data_unit" value="{{ $dataunit['id']}}" class="form-check-input @error('data_unit_id') is-invalid @enderror pl-2" {{ old('data_unit_id',$networkedstorage->data_unit_id) == $dataunit['id'] ? 'checked' : '' }}>
                                    ...
                                    <input class="form-control @error('hdd_total_cap') is-invalid @enderror" type="number" name="hdd_total_cap" id="hdd_total_cap" step="0.01" value="{{ old('hdd_total_cap',$networkedstorage->hdd_total_cap) }}">
                                    @error('hdd_total_cap')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--จำนวน HDD สูงสุด-->
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('no_of_physical_drive_max') is-invalid @enderror" name="no_of_physical_drive_max" id="no_of_physical_drive_max" min="0" value="{{ old('no_of_physical_drive_max',$networkedstorage->no_of_physical_drive_max) }}">
                                </div>
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--จำนวน HDD-->
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control @error('no_of_physical_drive_populated') is-invalid @enderror" name="no_of_physical_drive_populated" id="no_of_physical_drive_populated" value="{{ old('no_of_physical_drive_populated',$networkedstorage->no_of_physical_drive_populated) }}">
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--LUN-->
                                <div class="form-group">
                                    ...
                                    <input type="number" name="lun_count" id="lun_count" class="form-control @error('lun_count') is-invalid @enderror" value="{{ old('lun_count',$networkedstorage->lun_count) }}">
                                    @error('lun_count')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--ชื่อเครื่อง-->
                                <div class="form-group">
                                    ...
                                    <input type="text" name="device_name" id="device_name" class="form-control @error('device_name') is-invalid @enderror" value="{{ old('device_name',$networkedstorage->device_name) }}">
                                    @error('device_name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--address ควบคุมเครื่อง-->
                                <div class="form-group">
                                    ...
                                    <input type="text" name="device_management_address" id="device_management_address" class="form-control @error('device_management_address') is-invalid @enderror" value="{{ old('device_management_address',$networkedstorage->device_management_address) }}">
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--address รับส่งข้อมูล-->
                                <div class="form-group">
                                    ...
                                    <input type="text" name="device_communication_address" id="device_communication_address" class="form-control @error('device_communication_address') is-invalid @enderror" value="{{ old('device_communication_address',$networkedstorage->device_communication_address) }}">
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--protocol-->
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline pl-2">
                                        <label class="form-check-label"><input type="checkbox" class="form-check-input" name="is_smb" id="smb" value="1" {{ old('is_smb',$networkedstorage->is_smb) == 1 ? 'checked' : '' }}><label for="smb">SMB</label></label>
                                        <label class="form-check-label pl-2"><input type="checkbox" class="form-check-input" name="is_fc" id="fc" value="1" {{ old('is_fc',$networkedstorage->is_fc) == 1 ? 'checked' : '' }}><label for="is_fc">Fiber Channel</label></label>
                                        <label class="form-check-label pl-2"><input type="checkbox" class="form-check-input" name="is_iscsi" id="iscsi" value="1" {{ old('is_iscsi',$networkedstorage->is_iscsi) == 1 ? 'checked' : '' }}><label for="iscsi">iSCSI</label></label>
                                    </div> 
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--หมายเหตุ-->
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" name="remarks" id="remarks" rows="2">{{ old('remarks',$networkedstorage->remarks) }}</textarea>
                                </div>
                            </div>
                            <div class="col-sm-12 col-lg-6"> <!--issues-->
                                <div class="form-group">
                                    <label for="issues">ปัญหาในการใช้งาน</label>
                                    <textarea class="form-control" name="issues" id="issues" rows="2">{{ old('issues',$networkedstorage->issues) }}</textarea>
                                </div>
                            </div>
                        </div>
                    </div>
