                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        @foreach ($storagetypes as $storagetype)
                                            <input class="form-check-input @error('type') is-invalid @enderror" type="radio" name="type" id="type" value="{{ $storagetype['id'] }}" {{ old('type',$networkedstorage->type) == $storagetype['id'] ? 'checked' : '' }}>
