                            ...
                            <div class="col-sm-12 col-lg-6"> <!--การติตตั้ง-->
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <input class="form-check-input @error('is_mobile') is-invalid @enderror" type="radio" name="is_mobile" id="is_mobile" value="{{ $mobile['value'] }}" {{ old('is_mobile',$networkedstorage->is_mobile) == $mobile['value'] ? 'checked' : '' }}>
