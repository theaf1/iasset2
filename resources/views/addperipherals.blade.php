                ...
                <div class="card-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6"> <!--share-->
                            <div class="form-group">
                                <label for="is_shared" class="form-label">สถานะการใช้งานร่วมกัน</label>
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" name="is_shared" value="1" {{ old('is_shared') == 1 && old('is_shared') !== null ? 'checked' : '' }}>
                                    <label class="form-check-label" for="is_shared"> เป็นเครื่องใช้งานร่วมกัน</label>
                                </div>
                            </div>
                        </div>
                    </div>
