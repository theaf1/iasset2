                    ...
                    <div class="row">
                        <div class="col-sm-12 col-lg-6"> <!--รหัส SAP-->
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('sapid') is-invalid @enderror" id="sapid" name="sapid" placeholder="กรุณาใส่รหัส SAP" autofocus value="{{ old('sapid') }}"><button type="button" class="btn btn-primary mt-3" onclick="generateInternalSAP()">ให้รหัสภายใน</button>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-12 col-lg-6"> <!--ชนิด-->
                            <div class="form-group">
                                ...
                                <select class="form-select @error('device_subtype_id') is-invalid @enderror" name="device_subtype_id" id="device_subtype">
                                    <option value="" hidden></option>
                                    @foreach($netsubtypes as $netsubtype)
                                        <option value="{{ $netsubtype['id'] }}" {{ old('device_subtype_id') == $netsubtype['id'] ? 'selected' : '' }}>{{ $netsubtype['name'] }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6"> <!--การขยายขนาด-->
                            <div class="form-group">
                                <label for="is_modular" class="form-label">ความสามารถในการขยายขนาด</label>
                                <div class="form-check">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-6"> <!--power supply-->
                            <div class="form-group">
                                <label for="psu_count" class="form-label">จำนวน power supply</label>
