                    ...
                    <div class="form-row">
                        <div class="col-sm-12 col-lg-6"> <!--ชนิดครุภัณฑ์-->
                            <div class="form-group">
                                ...
                                <select class="form-control @error('type') is-invalid @enderror" id="type" name="type_id">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-lg-6"> <!--สถานะการใช้งาน-->
                            <div class="form-group">
                                ...
                                <select class="form-control @error('asset_use_status') is-invalid @enderror" name="asset_use_status_id" id="asset_use_status">
                                    <option value="" hidden selected></option>
