                        ...
                        <div class="form-row">
                            ...
                            <div class="col-sm-12 col-lg-6"> <!-- ห้อง -->
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control @error('location_id') is-invalid @enderror" name="room" id="room_autocomplete"  value="{{ old('room',$client->ClientRoom->name) }}"/>
                                    @error('location_id')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check-inline">
                                        @foreach ($opsfunctions as $opsfunction)
                                            <input type="radio" class="form-check-input @error('function_id') is-invalid @enderror" name="function_id" id="function" value="{{ $opsfunction['id'] }}" {{ old('function_id',$client->function_id) == $opsfunction['id'] ? 'checked' : ''}}>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check-inline pl-2">
                                        @foreach ($owners as $owner)
                                            <input type="radio" class="form-check-input ml-1 @error('owner_id') is-invalid @enderror" name="owner_id" id="owner1" value="{{ $owner['id'] }}" {{ old('owner_id',$client->owner_id) == $owner['id'] ? 'checked' : '' }}>
                                        ...
                                        <div class="form-row">   
                                            ...
                                            <div class="col-sm-12 col-lg-3"> <!--ขนาดจอ-->
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="display_size[]" id="display_size" type="number" min="0" step="0.1" value="{{ old('display_size.' . $i, isset($client->displays[$i]) ? $client->displays[$i]->display_size : null) }}"">
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('os_id') is-invalid @enderror" name="os_id" id="os_id">
                                        ...
                                        @foreach ($clientoses as $clientos)
                                            <option value="{{$clientos['id']}}" {{ old('os_id',$client->os_id) == $clientos['id'] ? 'selected' : '' }}>{{$clientos['name']}}</option>
                                        @endforeach
                                    </select>
                                    @error('os_id')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        @foreach ($os_arches as $os_arch)                               
                                            <div class="form-check-inline">
                                                <input type="radio" class="form-check-input  @error('os_arch_id') is-invalid @enderror" name="os_arch_id" id="os_arch" value="{{ $os_arch['id'] }}" {{ old('os_arch_id',$client->os_arch_id) == $os_arch['id'] ? 'checked' : ''}}><label class="form-check-label @error('os_arch_id') is-invalid @enderror" for="os_arch"> {{ $os_arch['name'] }}</label><br>
                                                @error('os_arch_id')
                                                    <div class="invalid-feedback">
                                                        {{ $message }}
                                                    </div>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--program ระบบ รพ-->
                                <div class="form-group">
                                    ...
                                    <div class="form-check-inline">
                                        <label class="checkbox-inline"><input type="checkbox" name="zoom" id="zoom" value="1" {{ old('zoom',$client->zoom) == 1 ? 'checked' : '' }}> Zoom</label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="checkbox-inline"><input type="checkbox" name="webex" id="webex" value="1" {{ old('webex',$client->webex) == 1 ? 'checked' : '' }}> Webex</label>
                                    </div>
                                </div>
                            </div>
