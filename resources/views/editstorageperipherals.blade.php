...
@section('content')
    <div class="container-fluid">
        <div class="col-12 mx-auto">
            <form action="{{ url('/storageperipheral',$storageperipheral->id) }}" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check form-check-inline">
                                        @foreach ($mobiles as $mobile)
                                            <input class="form-check-input" type="radio" name="is_mobile" id="is_mobile" value="{{ $mobile['value'] }}" {{ old('is_mobile') == $mobile['value'] && old('is_mobile') !== null ? 'checked' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('section') is-invalid @enderror" name="section" id="section">
                                        ...
                                        @foreach($sections as $section)
                                            <option value="{{ $section['id'] }}" {{ old('section',$storageperipheral->section) == $section['id'] ? 'selected' : '' }}>{{ $section['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('section')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="form-check">
                                        @foreach ($owners as $owner)
                                            <input class="form-check-input @error('owner') is-invalid @enderror" type="radio" name="owner" id="owner" value="{{ $owner['id'] }}" {{ old('owner',$storageperipheral->owner) == $owner['id'] ? 'checked' : ''}}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('asset_status') is-invalid @enderror" name="asset_status" id="asset_status">
                                        ...
                                        @foreach($asset_statuses as $asset_status)
                                            <option value="{{ $asset_status['id'] }}" {{ old('asset_status',$storageperipheral->asset_status) == $asset_status['id'] ? 'selected' : '' }}>{{ $asset_status['name'] }}</option>
                                        @endforeach
                                    </select>
                                    @error('asset_status')
                                        <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control @error('asset_use_status') is-invalid @enderror" name="asset_use_status" id="asset_use_status">
                                        ...
                                        @foreach($asset_use_statuses as $asset_use_status)
                                            <option value="{{ $asset_use_status['id'] }}" {{ old('asset_use_status',$storageperipheral->asset_use_status) == $asset_use_status['id'] ? 'selected' : '' }}>{{ $asset_use_status['name'] }}</option>
                                        @endforeach
                                    </select>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--ความจุข้อมูล-->
                                <div class="form-group">
                                    <label for="total_capacity">ความจุข้อมูล</label>
                                        <div class="form-check-inline pl-1">
                                            @foreach ($dataunits as $dataunit)
                                                <input type="radio" class="form-check-input @error('data_unit') is-invalid @enderror" name="data_unit" id="dataunit" value="{{ $dataunit['id'] }}" {{ old('data_unit',$storageperipheral->data_unit) == $dataunit['id'] ? 'checked' : '' }} >
                                    ...
                                    <input class="form-control @error('total_capacity') is-invalid @enderror" name="total_capacity" id="total_capacity" type="number" min="0" step="0.01" value="{{ old('total_capacity',$storageperipheral->total_capacity) }}">
                            ...
                            <div class="col-sm-12 col-lg-6"> <!--เป็นอุปกรณ์ hotswap-->
                                <div class="form-group">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="is_hotswap" id="is_hotswap" value="1" {{ old('is_hotswap',$storageperipheral->is_hotswap) == 1 ? 'checked' : '' }}>
                        ...
                        <div class="form-row">
                            <div class="col-sm-12 col-lg-6"> <!--จำนวน disk จำลองที่มีอยู่-->
                                <div class="form-group">
                                    ...
                                    <input class="form-control @error('lun_count') is-invalid @enderror" name="lun_count" id="lun_count" type="number" value="{{ old('lun_count',$storageperipheral->lun_count) }}">
                                    @error('lun_count')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
