                    ...
                    <div class="form-row">
                        <div class="col-sm-12 col-lg-6">
                            <div class="form-group"><!--ห้อง-->
                                ...
                                <input type="text" class="form-control @error('location_id') is-invalid @enderror" name="room" id="room_autocomplete" placeholder="กรุณาระบุห้องที่เครื่องตั้งอยู่" value="{{ old('room',$ups->UpsRoom->name) }}"/>
                                @error('location_id')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check form-check-inline">
                                    @foreach ($mobiles as $mobile)
                                        <input class="form-check-input @error('mobility_id') is-invalid @enderror" type="radio" name="mobility_id" id="is_mobile" value="{{ $mobile['id'] }}" {{ old('mobility_id',$ups->mobility_id) == $mobile['id'] ? 'checked' : '' }}>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-sm-12 col-lg-6"> <!--หน่วยงาน-->
                            <div class="form-group">
                                ...
                                <select class="form-control @error('section_id') is-invalid @enderror" id="section" name="section_id">
                                    <option value="" hidden selected>กรุณาเลือก</option>
                                    @foreach($sections as $section)
                                        <option value="{{ $section['id'] }}" {{ old('section_id',$ups->section_id) == $section['id']  ? 'selected' : ''}}>{{ $section['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('section_name')
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    @foreach ($owners as $owner)
                                        <input class="form-check-input @error('owner_id') is-invalid @enderror" type="radio" name="owner_id" id="owner" value="{{ $owner['id'] }}" {{ old('owner_id',$ups->owner_id) == $owner['id'] ? 'checked' : '' }}>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('asset_status_id') is-invalid @enderror" name="asset_status_id" id="asset_status">
                                    ...
                                    @foreach($asset_statuses as $asset_status)
                                        <option value="{{ $asset_status['id'] }}" {{ old('asset_status_id',$ups->asset_status_id) == $asset_status['id']  ? 'selected' : ''}}>{{ $asset_status['name'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('asset_use_status_id') is-invalid @enderror"name="asset_use_status_id" id="asset_use_status">
                                    ...
                                    @foreach($asset_use_statuses as $asset_use_status)
                                        <option value="{{ $asset_use_status['id'] }}" {{ old('asset_use_status_id',$ups->asset_use_status_id) == $asset_use_status['id']  ? 'selected' : ''}}>{{ $asset_use_status['name'] }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('topology_id') is-invalid @enderror" name="topology_id" id="topology">
                                    ...
                                    @foreach ($topos as $topo)
                                        <option value="{{ $topo['id'] }}" {{ old('topology_id',$ups->topology_id) == $topo['id'] ? 'selected' : '' }}>{{ $topo['name'] }}</option>
                                    @endforeach
                                </select>
                                @error('topology_id')
                                    <div class="invalid-feedback">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-check">
                                    @foreach ($bat_types as $bat_type)
                                        <input class="form-check-input" type="radio" name="battery_type_id" id="battery_type" value="{{ $bat_type['id'] }}" {{ old('battery_type_id',$ups->battery_type_id) == $bat_type['id'] ? 'checked' : ''}}>
